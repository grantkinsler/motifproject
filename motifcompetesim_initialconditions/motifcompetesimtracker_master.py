...
import sys
import getopt
from motifcompetesimtracker_motifoutput import motifcompetesim_motifoutput
from motifcompetesimtracker_fulltrialoutput import motifcompetesim_fulltrialoutput
from motifcompetesimtracker_allstrandoutput import motifcompetesim_allstrandoutput
from motifcompetesimtracker_elongdataoutput import motifcompetesim_elongdataoutput
from motifcompetesimtracker_initialconditions import motifcompetesimtracker_initialconditions
...
def main(argv):
	...
	try:
		opts, args = getopt.getopt(argv, "h", ["help","testprefix=","trials=","maxStrands=","maxStrandLength=","numCells=","numRounds=","motiflist=","elong=","biaslist=","elongdata=","ic_file="])
	...
	parameterlist = [trials, max_strand_nr, maxStrandLength, numCells, numRounds, motiflist, elong, biaslist, initialconditions_filename]

	celllist, elonglist = motifcompetesimtracker_initialconditions(initialconditions_filename)

	pop_tracker, nr_strands_per_time, elongation_tracker = motifcompetesim_motifoutput(celllist,elonglist,parameterlist,masterprefix,testprefix,trials,max_strand_nr,maxStrandLength,numCells,numRounds,motiflist,elong,biaslist)
