...
class Population:
	...
	def initial_condition_populate(self,celllist,elonglist,motiflist,max_strand_nr):
		for cell_iterator in xrange(len(celllist)):
			self.cells.append(Cell(celllist[cell_iterator],elonglist[cell_iterator],motiflist,max_strand_nr,'empty','empty','empty'))
