...
def motifsimtracker_fulltrialoutput(parameterlist,masterprefix,testprefix,trial_population_data,trial_elongation_data,trials,max_strand_nr,maxStrandLength,numCells,numRounds,motif,elong,bias):
