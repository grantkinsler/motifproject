...
import sys
import getopt
from motifcompetesim_gillespie_motifoutput import motifcompetesim_motifoutput
from motifcompetesim_gillespie_fulltrialoutput import motifcompetesim_fulltrialoutput
from motifcompetesim_gillespie_allstrandoutput import motifcompetesim_allstrandoutput
from motifcompetesim_gillespie_elongdataoutput import motifcompetesim_elongdataoutput
...
def main(argv):
	...
	masterprefix = 'MotifCompeteSimulation_Gillespie'

	parameterlist = [trials, max_strand_nr, maxStrandLength, numCells, numRounds, motiflist, elong, biaslist]

	pop_tracker, nr_strands_per_time, elongation_tracker, time_tracker = motifcompetesim_motifoutput(parameterlist,masterprefix,testprefix,trials,max_strand_nr,maxStrandLength,numCells,numRounds,motiflist,elong,biaslist)
